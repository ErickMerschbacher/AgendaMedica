...
namespace AgendaMedica.Controllers
{
    ...
    public class AgendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AgendaId,MedicoId,PacienteId,DataConsulta,Status")] Agenda agenda)
        {
            //Verificar se a dataConulta é >= data atual
            //Se for retornar com a mensagem de data invalida
            if (agenda.DataConsulta < DateTime.Now)
            {
                ModelState.AddModelError("DataConsulta", "A data da consulta deve ser maior ou igual a data atual.");
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("AgendaId,MedicoId,PacienteId,DataConsulta,Status")] Agenda agenda)
        {
